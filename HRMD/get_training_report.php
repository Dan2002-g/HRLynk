...
try {
    ...
    // Query to fetch employee names and their number of approved training
    $query = "
        SELECT 
            u.empname AS employee_name,
            COUNT(CASE WHEN t.status = 'Approved' THEN 1 ELSE NULL END) AS approved_training_count
        FROM users u
    ...
    $query .= " GROUP BY u.userID, u.empname ORDER BY approved_training_count DESC, u.empname ASC";
