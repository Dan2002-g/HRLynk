...
// Fetch competencies first to use both in the PHP dropdown and JavaScript
    ...
    <div class="guidelines">
        <div class="vertical-timeline">
            ...
            <div class="timeline-step">
                ...
                <div class="timeline-content">
                    <p><b>Step 4:</b> Get approval signatures from your supervisor, responsibility center head, and cluster head. Submit your competency and wait for the approval of the supervisor and HR.</p>
                </div>
            </div>
            <div class="timeline-step">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <select name="competency_id[]" required>
                                          ...
                                          <?php foreach ($competencies as $competency) {
                                              echo "<option value=\"{$competency['competency_id']}\">{$competency['competencyname']}</option>";
                                          } ?>
                                      </select>
                                  </div>
                                  <div class="form-group">
