                                ...
                                <?php foreach ($trainingResult as $training) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            if ($terminal_exists) {
                                                echo "<button class='btn btn-success view-terminal-btn' data-trainingid='" . $training['trainingid'] . "'style='padding: 5px 10px; font-size: 12px;'>
                                            ...
                                            if ($learningapp_exists) {
                                                echo "<button class='btn btn-success view-learningapp-btn' data-trainingid='" . $training['trainingid'] . "' style='padding: 5px 10px; font-size: 12px;'>
...
$(document).ready(function() {
    ...
    // Handle View Terminal Report button
    $(document).on('click', '.view-terminal-btn', function(e) {
        e.preventDefault();
        var trainingId = $(this).data('trainingid');
        ...
        $.ajax({
            ...
            error: function(xhr, status, error) {
                alert("Error loading terminal report: " + error);
            }
        });
    });
